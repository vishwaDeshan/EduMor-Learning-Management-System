    ...
    return (
        <div style={{ margin: "15px 20px 5px" }}>
            ...
            <Modal show={showForm} onHide={handleCloseForm}>
                ...
                <Modal.Body>
                    <Form onSubmit={handleSubmit} style={{ height: '350px', overflowY: 'scroll' }}>
                        <Form.Group controlId="formQuizName" style={{ marginBottom: '1rem' }}>
                        ...
                        <Form.Group controlId="formLevel">
                            ...
                            <DropdownButton title={selectedLevel || 'Select Level'} onSelect={handleLevelSelect} variant="outline-secondary">
                        ...
                        {questions.map((question, index) => (
                            <div key={index}>
                                <Form.Group controlId={`formQuestion${index}`}>
                                    ...
                                    <Form.Control type="text" name="question" placeholder='Enter the question' value={question.question} onChange={(event) => handleQuestionChange(event, index)} required />
                                </Form.Group>
                                ...
                                <Form.Group controlId={`formCorrectAnswer${index}`}>
                                    ...
                                    <Form.Control type="text" name="correctAnswer" placeholder='Enter the correct answer' value={question.correctAnswer} onChange={(event) => handleQuestionChange(event, index)} required />
                                </Form.Group>
                                <hr />
                            </div>
                        ))}
                        <button type="button" className="btn btn-outline-dark" onClick={handleAddQuestion}><AddIcon/>Add New Question</button>
                        <hr />
