...
const VideoUploadSection = () => {
  ...
  return (
    <div className="exam-uploader" style={{background:'#fff', padding:'10px', borderRadius:'10px'}}>
      ...
      />
      {!thumbnail && <p style={{ color: "red" }}>Please enter a thumbnail url</p>}
      ...
      <textarea
        ...
        className="textarea"
        style={{borderRadius:'10px', width:"920px",resize:'none', height:'50px'}}
      ...
      <button onClick={createLectureVideo} className="button" style={{borderRadius:'10px', padding:'10px 60px',margin:"10px auto"}}>
        Upload
      </button>
    </div>
  );
